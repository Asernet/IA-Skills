...
- Quale messaging vedono prima di questa pagina?
...
- Costruisci un flusso logico lungo la pagina
...
- Il tuo singolo messaggio più importante
- Deve comunicare la proposta di valore centrale
- Specifico > generico
...
**Il modo {opposto del solito} per {raggiungere risultato}**
_Esempio: Il modo più semplice per trasformare la tua passione in reddito_

**Non {evento spiacevole} mai più**
_Esempio: Non perdere mai più un'opportunità di vendita_

**{Feature chiave} per {pubblico target}**
_Esempio: Analytics avanzate per e-commerce Shopify_

**Non devi essere {competenze} per {raggiungere risultato}**
_Esempio: Con Ahrefs, non devi essere un esperto SEO per posizionarti meglio_

**{Raggiungi risultato} con {come il prodotto lo rende possibile}**
_Esempio: Genera più lead vedendo quali aziende visitano il tuo sito_

**Subheadline**

- Espande l'headline
- Aggiunge specificità o affronta preoccupazioni secondarie
- Max 1-2 frasi

**CTA Primaria**

- Testo del bottone orientato all'azione
- Comunica cosa ottengono, non cosa fanno
- "Inizia Prova Gratuita" > "Registrati"
- "Ottieni il Tuo Report" > "Invia"
...
- Loghi clienti (riconoscibili > tanti)
- Metrica chiave ("10.000+ team")
...
- Crea riconoscimento ("è esattamente il mio problema")

Struttura:

- "Conosci quella sensazione..." o "Se sei come la maggior parte dei [ruolo]..."
...
- Ogni step: azione semplice + risultato

Esempio:

1. "Collega i tuoi strumenti (2 minuti)"
2. "Imposta le tue preferenze"
3. "Ricevi report automatici ogni lunedì"
...
- Vedi [Prodotto] in Azione
- Crea il Tuo Primo [Cosa]
- Prenota la Mia Demo
- Scarica la Guida
- Prova Gratis

**Formula CTA:**
[Verbo Azione] + [Cosa Ottengono] + [Qualificatore se necessario]
...
Guida gli utenti attraverso il processo in 3-4 step chiari.

**Confronto Alternative/Competitor**
Mostra come ti posizioni rispetto allo status quo o competitor.

**Manifesto Founder / La Nostra Storia**
Condividi perché hai costruito questo e cosa credi. Crea connessione emotiva.

**Testimonianze**
Citazioni clienti con nomi, foto e risultati specifici.

**Case Study**
Storie più approfondite di successo clienti. Formato: Problema → Soluzione → Risultati.

**Casi d'Uso**
Mostra i diversi modi in cui il prodotto viene usato.

**Sezioni "Costruito Per"**
Chiama esplicitamente per chi è il prodotto.

**Stats e Social Proof**
Metriche chiave che costruiscono credibilità.

**FAQ**
Affronta obiezioni e domande comuni.

**Garanzia / Inversione Rischio**
Garanzia soddisfatti o rimborsati, termini prova gratuita.
